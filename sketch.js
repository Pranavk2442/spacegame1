...
var endSound, crashSound, asteroidShot, gameWon,restartSound,startSound;
...
function setup(){
  ...
  // spaceship.addImage(spaceshipimg);
   ...
   earth.scale=2;
    ...
    earth.debug=true;
    earth.setCollider("circle",0,0,20);
...
function draw(){
   ...
   // background(spacebgimg);
    ...
    if(gameState===0){
        ...
        textSize(20);
        text("Use left and right arrows to move, and press space to shoot. Your score increases for every asteroid you shoot.",100,100)
